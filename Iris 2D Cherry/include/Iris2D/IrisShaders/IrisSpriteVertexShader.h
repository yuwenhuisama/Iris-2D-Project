...
namespace Iris2D
{
	...
	private:
		...
		//ID3D11Buffer* m_pPosMatrixBuffer = nullptr;
		//ID3D11Buffer* m_pRotMatrixBuffer = nullptr;
		//ID3D11Buffer* m_pZoomMatrixBuffer = nullptr;
	...
	public:
		...
		void SetWorldMatrix(const IrisSpriteMatrixBuffer& mbBuffer);
