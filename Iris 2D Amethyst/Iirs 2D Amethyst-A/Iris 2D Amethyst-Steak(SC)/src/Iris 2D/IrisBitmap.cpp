...
void IrisBitmap::MakeTexture(const IrisRect* limitRect){
	//HRESULT r = D3DXCreateTextureFromFile(this->Device, "Leimu.jpg", &(this->texture));
	//return;
	//if(r == D3D_OK)
	//	::MessageBox(0, "1", "1", 0);
...
void IrisBitmap::Draw(IrisViewport *tViewport, const IrisRect* Rect){
	bool flag = false;
	...
	if (flag)
		this->MakeTexture(tone, this->limitRect);
}
