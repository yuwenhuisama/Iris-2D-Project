...
private:
	...
	void MakeTexture(const IrisTone* tone, const IrisRect* limitRect, int opacity = 255);
...
public:
	...
	void Draw(int opacity, IrisViewport *viewport, const IrisRect* limitRect, const IrisTone* tone);
