	...
	IDirect3DDevice9** device)
{
	...
	Iris2D::ModuleIrisGraphics::SetHwnd(hwnd);
	...
	D3DPRESENT_PARAMETERS& d3dpp = Iris2D::IrisApp::Instance()->curD3DParameters;
...
bool d3d::InitD3DShader(IDirect3DDevice9* Device){
	Iris2D::IrisShader* shader = Iris2D::IrisShader::Instance();
	return shader->InitShader(Device, L"hlsl\\SpriteShader.hlsl",
...
LRESULT CALLBACK d3d::WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam){
	...
	case WM_DESTROY:
		::PostQuitMessage(0);
		Iris2D::IrisApp::Instance()->GoQuit();
		break;
	}
