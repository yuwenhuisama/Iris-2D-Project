...
private:
	struct IrisValueHash {
		size_t operator () (const IrisValue& ivValue) const {
			if (((IrisValue&)ivValue).GetObjectPointer()->GetClass()->GetClassName() == "Integer") {
				return size_t(IrisInteger::GetIntData((IrisValue&)ivValue));
			}
			else if (((IrisValue&)ivValue).GetObjectPointer()->GetClass()->GetClassName() == "Float") {
				int e = 0;
			...
			else if (((IrisValue&)ivValue).GetObjectPointer()->GetClass()->GetClassName() == "String") {
				...
				return (size_t)((IrisValue&)ivValue).GetObjectPointer()->GetObjectID();
			}
		}
	};
	...
	struct IrisValueCmp {
		bool operator()(const IrisValue& ivValue1, const IrisValue& ivValue2) const {
			if(((IrisValue&)ivValue1).GetObjectPointer()->GetClass()->GetClassName() == "Integer"
				&& ((IrisValue&)ivValue2).GetObjectPointer()->GetClass()->GetClassName() == "Integer") {
				return IrisInteger::GetIntData((IrisValue&)ivValue1) == IrisInteger::GetIntData((IrisValue&)ivValue2);
			}
			else if (((IrisValue&)ivValue1).GetObjectPointer()->GetClass()->GetClassName() == "Float"
				&& ((IrisValue&)ivValue2).GetObjectPointer()->GetClass()->GetClassName() == "Float") {
				return IrisFloat::GetFloatData((IrisValue&)ivValue1) == IrisFloat::GetFloatData((IrisValue&)ivValue2);
			}
			else if (((IrisValue&)ivValue1).GetObjectPointer()->GetClass()->GetClassName() == "String"
				&& ((IrisValue&)ivValue2).GetObjectPointer()->GetClass()->GetClassName() == "String") {
				return IrisString::GetString((IrisValue&)ivValue1) == IrisString::GetString((IrisValue&)ivValue2);
			}
			else {
				return ((IrisValue&)ivValue1).GetObjectPointer()->GetObjectID() == ((IrisValue&)ivValue2).GetObjectPointer()->GetObjectID();
			}
		}
	};
