...
namespace Iris2D {
	...
	IRIS2DLIBRARY_API IIrisColor* GetTravialIIrisColor(IR_PARAM_RESULT);
	...
	IRIS2DLIBRARY_API IIrisFont* GetTravialIIrisFont(IR_PARAM_RESULT);
	...
	IRIS2DLIBRARY_API IIrisSprite* GetTravialIIrisSprite(IR_PARAM_RESULT);
	...
	IRIS2DLIBRARY_API IIrisRect* GetTravialIIrisRect(IR_PARAM_RESULT);
	...
	IRIS2DLIBRARY_API IIrisTone* GetTravialIIrisTone(IR_PARAM_RESULT);
