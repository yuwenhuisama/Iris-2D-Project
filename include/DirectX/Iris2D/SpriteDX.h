...
namespace Iris2D
{
	...
	private:
		...
		ViewportDX* m_pViewport = nullptr;
	...
	public:
		...
		*/
		static SpriteDX* Create(ViewportDX* pViewport = nullptr);
		...
		*/
		...
		static void InnerRelease(SpriteDX* pSprite);
	...
	public:
		...
		*/
		void SetBitmap(BitmapDX*& pBitmap);
		BitmapDX* GetBitmap() const;
