...
namespace Iris2D
{
	...
	class BitmapDX: public RefCounter
	{
	private:
		TextureDX* m_pTexture = nullptr;
		FontDX* m_pFont = nullptr;
	...
	public:
		...
		* @see CopyFrom(BitmapDX* pSrcBitmap, IR_PARAM_RESULT)
		*/
		static BitmapDX* Create(BitmapDX* pSrcBitmap, IR_PARAM_RESULT);
		...
		*
		*/
		static BitmapDX* CopyFrom(BitmapDX* pSrcBitmap, IR_PARAM_RESULT);
		...
		*/
		virtual bool Blt(unsigned int nDestX, unsigned int nDestY,  const BitmapDX* pSrcBitmap, const RectDX* pSrcRect, float fOpacity, IR_PARAM_RESULT);
		...
		* @return 如果拷贝操作成功，返回 true 否则返回 false。
		*/
		virtual bool StretchBlt(const RectDX* pDestRect, const BitmapDX* pSrcBitmap, const RectDX* pSrcRect, float fOpacity, IR_PARAM_RESULT);
		...
		* @see FilleRect(RectDX* pRect, ColorDX* pColor, IR_PARAM_RESULT)
		*/
		virtual bool FillRect(unsigned nX, unsigned nY, unsigned nWidth, unsigned nHeight, const ColorDX* pColor, IR_PARAM_RESULT);
		/**
		* \~english
		* Fill an area of current bitmap with specified color.
		*
		...
		* @see FilleRect(RectDX* pRect, ColorDX* pColor, IR_PARAM_RESULT)
		*/
		virtual bool FillRect(const RectDX* pRect, const ColorDX* pColor, IR_PARAM_RESULT);
		...
		* @see ClearRect(unsigned int nX, unsigned int nY, unsigned int nWidth, unsigned int nHeight, IR_PARAM_RESULT)
		*/
		virtual bool ClearRect(const RectDX* pRect, IR_PARAM_RESULT);
		...
		*/
		virtual ColorDX* GetPixel(unsigned int nX, unsigned int nY, IR_PARAM_RESULT) const;
		...
		*/
		virtual bool SetPixel(unsigned int nX, unsigned int nY, const ColorDX *pColor, IR_PARAM_RESULT);
		...
		*/
		...
		virtual void SetFont(FontDX*& pFont);
		virtual FontDX* GetFont() const;

		virtual unsigned int TextSize(const FontDX* pFont, const std::wstring& wstrText, IR_PARAM_RESULT);
		...
		virtual bool DrawText(const RectDX* pRect, const std::wstring& wstrText, AlignType nAlign, IR_PARAM_RESULT);
