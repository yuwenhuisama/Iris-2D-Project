...
namespace Iris2D.NativeBridge
{
    ...
    public static class BitmapNative
    {
        ...
        public static extern Int32 Blt(IntPtr hHandle, UInt32 nDestX, UInt32 nDestY, IntPtr hSrcBitmap, IntPtr hSrcRect, float fOpacity);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_StretchBlt", CharSet = CharSet.Unicode)]
        public static extern Int32 StretchBlt(IntPtr hHandle, IntPtr hDestRect, IntPtr hSrcBitmap, IntPtr hSrcRect, float fOpacity);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_FillRect", CharSet = CharSet.Unicode)]
        public static extern Int32 FillRect(IntPtr hHandle, UInt32 nX, UInt32 nY, UInt32 nWidth, UInt32 nHeight, IntPtr hColor);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_FillRect2", CharSet = CharSet.Unicode)]
        public static extern Int32 FillRect(IntPtr hHandle, IntPtr hRect, IntPtr hColor);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_Clear", CharSet = CharSet.Unicode)]
        public static extern Int32 Clear(IntPtr hHandle);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_ClearRect", CharSet = CharSet.Unicode)]
        public static extern Int32 ClearRect(IntPtr hHandle, UInt32 nX, UInt32 nY, UInt32 nWidth, UInt32 nHeight);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_ClearRect2", CharSet = CharSet.Unicode)]
        public static extern Int32 ClearRect(IntPtr hHandle, IntPtr hRect);
        ...
        public static extern Int32 SetPixel(IntPtr hHandle, UInt32 nX, UInt32 nY, IntPtr hColor);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_SaveToFile", CharSet = CharSet.Unicode)]
        public static extern Int32 SaveToFile(IntPtr hHandle, string wstrFilePath);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_HueChange", CharSet = CharSet.Unicode)]
        public static extern Int32 HueChange(IntPtr hHandle, float fHue);
        ...
        public static extern Int32 DrawText(IntPtr hHandle, UInt32 nX, UInt32 nY, UInt32 nWidth, UInt32 nHeight, string wstrText, BitmapAlignType nAlign);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_DrawText2", CharSet = CharSet.Unicode)]
        public static extern Int32 DrawText(IntPtr hHandle, IntPtr hRect, string wstrText, BitmapAlignType nAlign);

        [DllImport("libiris2d.dll", EntryPoint = "Bitmap_Dispose", CharSet = CharSet.Unicode)]
        public static extern Int32 Dispose(IntPtr hHandle);
    }
}