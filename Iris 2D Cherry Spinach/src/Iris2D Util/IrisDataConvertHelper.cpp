...
namespace Iris2D {
	D2D1_RECT_F IrisDataConvertHelper::ConvertToD2DRectF(IrisRect * pRect)
	{
		return D2D1::RectF(pRect->GetLeft(), pRect->GetTop(), pRect->GetRight(), pRect->GetBottom());
	}

	D2D1_RECT_U IrisDataConvertHelper::ConvertToD2DRectU(IrisRect * pRect)
	{
	...
	D2D1::ColorF IrisDataConvertHelper::ConvertToD2DColor(IrisColor * pColor)
	{
